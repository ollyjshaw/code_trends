...
public class InputFormHelper {
	...
	public void populateInputFormTextFields(WebDriver driver, String language1, String language2, String language3){
		
		webDriverHelper.clearAndPopulateTextFieldByName(driver, LANGUAGE1_ID, language1);
		webDriverHelper.clearAndPopulateTextFieldByName(driver, LANGUAGE2_ID, language2);
		webDriverHelper.clearAndPopulateTextFieldByName(driver, LANGUAGE3_ID, language3);	
	}
	
	public void populateDefaultLaguageDetails(WebDriver driver){
		
		populateInputFormTextFields(driver, LANGUAGE1_DEFAULT, LANGUAGE2_DEFAULT, LANGUAGE3_DEFAULT);
	}
